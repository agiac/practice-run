...
// Source: practice-run/chat (interfaces: roomManager)
//
...
func (m_2 *RoomManager) AddMember(ctx context.Context, r *room.Room, m room.Member) error {
	m_2.ctrl.T.Helper()
...
func (m_2 *RoomManager) RemoveMember(ctx context.Context, r *room.Room, m room.Member) error {
	m_2.ctrl.T.Helper()
...
func (m_2 *RoomManager) SendMessage(ctx context.Context, r *room.Room, m room.Member, message string) error {
	m_2.ctrl.T.Helper()
