...
// Source: practice-run/chat (interfaces: roomRepository)
//
...
func (m *RoomRepository) CreateRoom(ctx context.Context, roomName string) (*room.Room, error) {
	m.ctrl.T.Helper()
...
func (m *RoomRepository) GetRoom(ctx context.Context, roomName string) (*room.Room, error) {
	m.ctrl.T.Helper()
